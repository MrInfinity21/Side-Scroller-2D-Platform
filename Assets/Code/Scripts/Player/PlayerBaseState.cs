    ...
    public class PlayerBaseState : State
    {
        ...
        public virtual void SetXVelocity(float turnSpeed, float maxAcceleration, float maxDeceleration)
        {
            ...
            if (Mathf.Abs(_player.Data.MovementDirection) > 0.05f)
            {
                ...
                if(_player.Data.MovementDirection * _player.RB.linearVelocity.x < 0)
                {
            ...
            _player.RB.linearVelocity = new Vector2(Mathf.MoveTowards(_player.RB.linearVelocity.x, desiredVelocity, maxSpeedChange),
