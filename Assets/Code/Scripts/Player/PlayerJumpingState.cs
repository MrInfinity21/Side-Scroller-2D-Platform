...
namespace Code.Scripts.Player
{
    public class PlayerJumpingState : PlayerBaseState
    {
        ...
        public override void Enter()
        {
            ...
            _player.RB.linearVelocity = new Vector2(_player.RB.linearVelocity.x, jumpSpeed);
        ...
        protected override void CalculateGravity()
        {
            ...
            if (_player.RB.linearVelocity.y < -0.01f)
            {
        ...
        public override void FixedUpdate()
        {
            ...
            _player.RB.linearVelocity = new Vector2(_player.RB.linearVelocity.x,
