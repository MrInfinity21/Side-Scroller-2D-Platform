...
namespace Code.Scripts.Player
{
    public class PlayerInAirState : PlayerBaseState
    {
        ...
        {
            _player.Data.GravityMultiplier = _player.RB.linearVelocity.y < -0.01f
        ...
        {
            base.FixedUpdate(); 
            _player.RB.linearVelocity = new Vector2(_player.RB.linearVelocity.x, Mathf.Clamp(_player.RB.linearVelocity.y, -_player.Data.TerminalVelocity, 100f));
